...
1. Download and unpack the latest version of Webmail Lite 8 into your installation root directory (currently it's version 0.5.1)
`https://github.com/afterlogic/webmail-lite-8/archive/0.5.1.zip`
